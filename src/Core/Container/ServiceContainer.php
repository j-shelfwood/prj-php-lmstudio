...
namespace Shelfwood\LMStudio\Core\Container;
...
class ServiceContainer implements ContainerInterface
{
    ...
    protected function registerDefaults(): void
    {
        ...
        $this->bind(\Shelfwood\LMStudio\Http\Factory\RequestFactoryInterface::class, function () {
            return new \Shelfwood\LMStudio\Http\Factory\RequestFactory(
                $this->get(LMStudioConfig::class)
            );
        });

        // Register the conversation manager
        $this->bind(\Shelfwood\LMStudio\Chat\ConversationManagerInterface::class, function () {
            return new \Shelfwood\LMStudio\Chat\ConversationManager(
                $this->get(LMStudioClientInterface::class),
                $this->get(\Shelfwood\LMStudio\Http\Factory\RequestFactoryInterface::class)
            );
        });

        // Register the tool registry
        $this->bind(\Shelfwood\LMStudio\Tool\ToolRegistryInterface::class, function () {
            return new \Shelfwood\LMStudio\Tool\ToolRegistry;
        });
