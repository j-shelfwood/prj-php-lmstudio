...
test('can create response format with text type', function (): void {
    ...
    expect($responseFormat->getType())->toBe(ResponseFormatType::TEXT);
    expect($responseFormat->getJsonSchema())->toBeNull();
});
...
test('can create response format with json schema type', function (): void {
    ...
    expect($responseFormat->getType())->toBe(ResponseFormatType::JSON_SCHEMA);
    expect($responseFormat->getJsonSchema())->toBe($jsonSchema);
});
