...
test('conversation can handle tool calls and responses', function (): void {
    ...
    $toolResponse = json_decode(file_get_contents(__DIR__.'/../mocks/chat/tool-response.json'), true);
    $standardResponse = json_decode(file_get_contents(__DIR__.'/../mocks/chat/standard-response.json'), true);
